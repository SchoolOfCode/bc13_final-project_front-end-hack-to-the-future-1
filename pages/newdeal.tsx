  ...
  return (
    <div className='flex flex-col w-full h-full bg-slate-800'>
      ...
      >
        ...
        <div id='DealCard container' className='flex justify-center items-center h-80 py-3 min-w-5/6 max-w-5/6'>
          <DealCard
            businessName={business?.name}
            dealText={offerText ? offerText : 'Your Offer Here'}
            dealHighlight={timeRemaining? timeRemaining : 'Time Remaining'}
            dealTime={endDate? new Date(endDate).toLocaleString(): "Deal End Date"}
          />
        </div>
