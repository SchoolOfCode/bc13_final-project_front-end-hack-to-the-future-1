...
function BusinessDeal({
  ...
  return (
    <div className="flex flex-col justify-center items-center text-center mb-8">
      ...
      <h2 className="font-Open text-indigo-200 text-xl text-center mb-2">
        {dealText}
      </h2>
      <hr className="border-1 w-4/5 border-slate-800 py-2"></hr>
      <p className="font-Open font-light text-slate-200 text-lg">{dealTime}</p>
